...
.\.venv\Scripts\python.exe -m pytest -q -m integration tests/test_persistence.py tests/test_query_persistence.py tests/test_processing_persistence.py
...
pytest -q -m integration tests/test_persistence.py tests/test_query_persistence.py tests/test_processing_persistence.py
