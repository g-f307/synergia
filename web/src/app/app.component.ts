...
interface NavigationItem { label: string; route: string; permission: string; icon: string; implemented: boolean; }
...
export class AppComponent {
  ...
  readonly items: NavigationItem[] = [
    { label: 'Visão geral', route: '/dashboard', permission: 'dashboard.read', icon: 'dashboard.svg', implemented: false },
    { label: 'Nova importação', route: '/imports/new', permission: 'import.create', icon: 'spreadsheet.svg', implemented: false },
    { label: 'Consulta', route: '/search', permission: 'business.read', icon: 'search.svg', implemented: false },
    { label: 'Pendências', route: '/pending-items', permission: 'pending.read', icon: 'queue.svg', implemented: false }
  ];
